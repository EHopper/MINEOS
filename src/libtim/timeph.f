c	subroutine name changed from time to timeph to be compatible
c	with HP fortran (time is a intrinsic function on hp's)
c	JM 1/97
c
      subroutine timeph(abstime,jyr,jmo,jdy,jhr,jmn,sec)
c
c   Purpose:
...
c
      ...
      dimension syr(0:110),smon(13),smol(13)
      integer*4 jyr,jmo,jdy,jhr,jmn
c
