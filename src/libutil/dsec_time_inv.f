      subroutine dsec_time_inv(tsec,ibyr,iyr,idoy,ihr,imin,sec)
c
...
c
c     Double precision -- expects tsec as real*8
c  
c
      integer*4 iyr, idoy, ihr, imin, ibyr, lpyr
      real*4 sec
      real*8 tsec, spyr,spday, sphr
c
      include 'numerical.h'
c
...
c     that idoy starts at 1 since there is no day 0.
      ...
      tsec = tsec - dble(idoy-1)*spday 
      ihr =  int(tsec/sphr)
      tsec = tsec - dble(ihr)*sphr
      imin = int(tsec/spmin)
